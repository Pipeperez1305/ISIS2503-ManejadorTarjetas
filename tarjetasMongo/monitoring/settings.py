...
#         'NAME':os.path.join(BASE_DIR, 'db.sqlite3'), #os.environ.get('TARJETAS_DB_NAME', 'tarjetas_db'),
#         # 'USER': os.environ.get('TARJETAS_DB_USER', 'tarjetas_user'),
#         # 'PASSWORD': os.environ.get('TARJETAS_DB_PASSWORD', 'isis2503'),
#         # 'HOST': os.environ.get('TARJETAS_DB_HOST', 'localhost'),
#         # 'PORT': '5432',
#     }
# }
